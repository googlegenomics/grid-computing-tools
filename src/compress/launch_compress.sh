...
#
#   gs://my_bucket/my_path/dir1/just_one_file.gz
#   gs://my_bucket/my_path/dir2/*.gz
#
...
#   DRYRUN=1 ./src/compress/launch_compress.sh samples/compress/gzip_compress.sh
#
# Example real usage:
#   ./src/compress/launch_compress.sh samples/compress/gzip_compress.sh
#
...
#   DRYRUN=1 LAUNCH_MIN=1 LAUNCH_MAX=1 ./src/compress/launch_compress.sh samples/compress/gzip_compress.sh
#
# Example real usage processing only the first 5 records:
#   LAUNCH_MIN=1 LAUNCH_MAX=5 ./src/compress/launch_compress.sh samples/compress/gzip_compress.sh
#
...
#
# The do_compress.sh script has built-in support for gzip and bzip2
...
#  -N: Job name
readonly COMPRESS_SRC_ROOT=$(readlink -f $(dirname ${0}))

export SRC_ROOT=$(dirname ${COMPRESS_SRC_ROOT})
